...
myst_substitutions = {
    ...
    'AseCalculation': '{class}`~aiida_quantumespresso.calculations.ase.AseCalculation`',
    'AseBaseWorkChain': '{class}`~aiida_quantumespresso.workflows.ase.base.AseBaseWorkChain`',
    'RelaxComparisonWorkChain': '{class}`~aiida_quantumespresso.workflows.relax_comparison.RelaxComparisonWorkChain`',
    'EosComparisonWorkChain': '{class}`~aiida_quantumespresso.workflows.eos_comparison.EosComparisonWorkChain`',
    'PhononComparisonWorkChain': '{class}`~aiida_quantumespresso.workflows.phonon_comparison.PhononComparisonWorkChain`',
